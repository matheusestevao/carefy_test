                ...
                <div class="card-body">
                    <form class="row g-3" action="{{ route('client.store') }}" method="POST">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control name" id="inputName" value="{{ old('name')}}">
                        </div>

                        <div class="col-md-2">
                            <label for="inputBirth" class="form-label">Data de Nascimento</label>
                            <input type="date" name="birth" class="form-control birth" id="inputBirth" value="{{ old('birth')}}" placeholder="00/00/0000">
                        </div>

                        <div class="col-md-3">
                            <label for="inputPhone" class="form-label">Contato</label>
                            <input type="text" name="phone" class="form-control phone" id="inputPhone" value="{{ old('phone')}}" placeholder="(00) 0000-0000">
                        </div>

                        <div class="row mt-2">
                            <div class="col-md-2">
                                <label for="inputZipCode" class="form-label">CEP:</label>
                                <input type="text" name="zip_code" class="form-control zip_code" id="zip_code" value="{{ old('zip_code')}}">
                            </div>

                            <div class="col-md-4">
                                <label for="inputAddress" class="form-label">Endereço:</label>
                                <input type="text" name="address" class="form-control address" id="address" value="{{ old('address')}}">
                            </div>

                            <div class="col-md-1">
                                <label for="inputNumberAddress" class="form-label">Número:</label>
                                <input type="text" name="number_address" class="form-control number_address" id="number_address" value="{{ old('number_address')}}">
                            </div>

                            <div class="col-md-3">
                                <label for="inputComplement" class="form-label">Complemento:</label>
                                <input type="text" name="complement" class="form-control complement" id="complement" value="{{ old('complement')}}">
                            </div>

                            <div class="col-md-2">
                                <label for="inputNeighborhood" class="form-label">Bairro:</label>
                                <input type="text" name="neighborhood" class="form-control neighborhood" id="neighborhood" value="{{ old('neighborhood')}}">
                            </div>
                        </div>
